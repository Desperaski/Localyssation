## 2.4.4
- Добавлены отсутствующие и исправлены сломанные ключи для слайдеров в меню создания персонажа
- Добавлены отсутствующие ключи для взаимодействий(F)
- Еще исправления в окнах квестов
- Добавлены ключи окна хранилища предметов (мимика)
- Добавлен отступ между строками с названием предмета и его редкостью
- Добавлены ключи для кнопок покупки-продажи в окнах торговцев
- Добавлены ключи для системных сообщений (скорее всего не для всех имеющихся)

## 2.4.3
- Улучшено переключение между текстом и ключами перевода в режиме переводчика
- Добавлены отсутствующие ключи в квестах

## 2.4.2
- Мелкие технические исправления

## 2.4.1
- Добавлены отсутствующие ключи для главного меню и меню настроек
- Добавлен хоткей на F8 для показа ключей перевода
